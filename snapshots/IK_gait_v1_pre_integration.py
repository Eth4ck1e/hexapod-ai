...
def smart_compute(t):
    ...
    # Smart phases ignore manual tilt cycle by default (their behavior is
    # scripted), but honor an explicit "tilt_pitch_deg" / "tilt_roll_deg" param.
    p_deg = params.get("tilt_pitch_deg", 0.0)
    r_deg = params.get("tilt_roll_deg",  0.0)
...
def compute_joints(t):
    ...
    # Live stance + tilt + speed modulation (manual modes).
